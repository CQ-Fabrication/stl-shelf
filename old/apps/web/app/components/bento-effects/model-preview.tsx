    ...
    <div className={cn("absolute inset-0 overflow-hidden", className)}>
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="relative h-32 w-32">
          ...
          <svg viewBox="0 0 100 100" className="h-full w-full animate-rotate-slow">
            ...
            {/* Connecting edges */}
            <line x1="30" y1="35" x2="40" y2="25" stroke="rgba(249, 115, 22, 0.5)" strokeWidth="1" />
            <line x1="70" y1="35" x2="80" y2="25" stroke="rgba(249, 115, 22, 0.5)" strokeWidth="1" />
            <line x1="70" y1="75" x2="80" y2="65" stroke="rgba(249, 115, 22, 0.5)" strokeWidth="1" />
            <line x1="30" y1="75" x2="40" y2="65" stroke="rgba(249, 115, 22, 0.3)" strokeWidth="1" strokeDasharray="3 2" />

            {/* Center cross for depth */}
            <line x1="50" y1="30" x2="50" y2="70" stroke="rgba(249, 115, 22, 0.15)" strokeWidth="0.5" />
            <line x1="35" y1="50" x2="75" y2="50" stroke="rgba(249, 115, 22, 0.15)" strokeWidth="0.5" />
          </svg>
      ...
      <div className="absolute bottom-4 right-4 flex items-center gap-1.5">
        <svg viewBox="0 0 20 20" className="h-4 w-4 animate-spin-slow">
          <circle cx="10" cy="10" r="7" fill="none" stroke="rgba(249, 115, 22, 0.3)" strokeWidth="1.5" />
          <path d="M 10 3 A 7 7 0 0 1 17 10" fill="none" stroke="rgb(249, 115, 22)" strokeWidth="1.5" strokeLinecap="round" />
        </svg>
