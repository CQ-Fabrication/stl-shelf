  ...
  return (
    <div className={cn("absolute inset-0 overflow-hidden", className)}>
      ...
      <svg className="absolute inset-0 h-full w-full pointer-events-none opacity-20">
        <line x1="30%" y1="40%" x2="50%" y2="50%" stroke="rgb(249, 115, 22)" strokeWidth="0.5" strokeDasharray="2 4" />
        <line x1="70%" y1="35%" x2="50%" y2="50%" stroke="rgb(168, 85, 247)" strokeWidth="0.5" strokeDasharray="2 4" />
        <line x1="40%" y1="70%" x2="50%" y2="50%" stroke="rgb(34, 197, 94)" strokeWidth="0.5" strokeDasharray="2 4" />
      </svg>
