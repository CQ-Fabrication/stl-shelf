  ...
  return (
    <div className="relative h-20 w-full flex items-center justify-center">
      ...
      <div className="relative w-24 h-16">
        ...
        {/* Star sparkles */}
        <svg className="absolute -top-1 right-2 h-3 w-3 text-yellow-400/60 animate-twinkle" viewBox="0 0 24 24" fill="currentColor">
  ...
  return (
    <div className="relative h-20 w-full flex items-center justify-center">
      ...
      <svg viewBox="0 0 80 50" className="h-16 w-20">
        {/* Main branch */}
        <line x1="10" y1="25" x2="70" y2="25" stroke="rgb(168, 85, 247)" strokeWidth="2" strokeOpacity="0.5" />

        {/* Branch off */}
        <path d="M 30 25 Q 40 25 45 15" fill="none" stroke="rgb(168, 85, 247)" strokeWidth="1.5" strokeOpacity="0.4" strokeDasharray="3 2" />

        {/* Merge back */}
        <path d="M 45 15 Q 50 15 55 25" fill="none" stroke="rgb(168, 85, 247)" strokeWidth="1.5" strokeOpacity="0.4" strokeDasharray="3 2" />

        {/* Version commits */}
        <g className="animate-pulse-commit">
          <circle cx="15" cy="25" r="4" fill="rgb(168, 85, 247)" fillOpacity="0.8" />
          <text x="15" y="38" fontSize="6" fill="rgb(148, 163, 184)" fontFamily="monospace" textAnchor="middle">v1.0</text>
        </g>
        ...
        <g className="animate-pulse-commit" style={{ animationDelay: "0.4s" }}>
          ...
          <text x="45" y="8" fontSize="5" fill="rgb(148, 163, 184)" fontFamily="monospace" textAnchor="middle">fix</text>
        </g>
        ...
        <g className="animate-pulse-commit" style={{ animationDelay: "0.8s" }}>
          <circle cx="70" cy="25" r="5" fill="rgb(34, 197, 94)" fillOpacity="0.9" className="animate-glow-green" />
          <text x="70" y="38" fontSize="6" fill="rgb(148, 163, 184)" fontFamily="monospace" textAnchor="middle">v2.0</text>
        </g>
      </svg>
    </div>
  )
          ...
          <div key={i} className="relative" style={{ animationDelay: `${i * 0.2}s` }}>
            ...
            <div className="h-10 w-8 rounded border border-slate-600/50 bg-gradient-to-b from-slate-700/60 to-slate-800/80">
              ...
              <div
                ...
                style={{ top: printer.status === "printing" ? `${100 - printer.progress}%` : "20%" }}
              />
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <div className={`absolute -top-2 -right-1 font-mono text-[64px] font-bold leading-none select-none transition-colors duration-500 ${colors.numberBg}`}>
                    {useCase.number}
                  </div>
                  ...
                  <div className="relative z-10">
                    {/* Icon with glow */}
                    <div className={`inline-flex items-center justify-center w-10 h-10 rounded-lg border ${colors.border} ${colors.bg} ${colors.bgHover} mb-3 transition-all duration-300`}>
                    ...
                    {/* Stat badge */}
                    <div className={`inline-flex items-center gap-1.5 px-2 py-1 rounded-full text-[10px] font-mono ${colors.badgeBg} ${colors.textMuted} border ${colors.badgeBorder}`}>
                      <span className={`h-1 w-1 rounded-full ${colors.bg.replace('/10', '')} animate-pulse`} />
                      {useCase.stat}
                    </div>
                  </div>

                  {/* Bottom accent line */}
                  <div className={`absolute bottom-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-transparent to-transparent group-hover:via-current transition-all duration-500 ${colors.textMuted}`} />
                </div>
              </div>
            )
          })}
