...
const page = seoPages.stlVersionControlForMakers;

export const Route = createFileRoute("/stl-version-control-for-makers")({
  component: StlVersionControlForMakersPage,
  loader: async () => {
...
function StlVersionControlForMakersPage() {
