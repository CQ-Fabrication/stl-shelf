...
const page = seoPages.openSourceStlLibrarySoftware;

export const Route = createFileRoute("/open-source-stl-library-software")({
  component: OpenSourceStlLibrarySoftwarePage,
  loader: async () => {
...
function OpenSourceStlLibrarySoftwarePage() {
