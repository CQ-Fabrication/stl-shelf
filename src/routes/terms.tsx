        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto prose prose-neutral dark:prose-invert prose-headings:font-bold prose-h2:text-2xl prose-h2:mt-12 prose-h2:mb-4 prose-h3:text-lg prose-h3:mt-8 prose-h3:mb-3 prose-p:text-muted-foreground prose-li:text-muted-foreground">
              ...
              <p>
                By accessing or using STL Shelf ("Service"), you agree to be bound by these Terms of
                Service. If you disagree with any part of these terms, you do not have permission to
                access the Service.
              </p>

              <h2>Description of Service</h2>
              <p>
                STL Shelf is a 3D model library management platform that allows users to organize,
                preview, and manage their 3D printable files. The Service is available as:
              </p>
              <ul>
              ...
              <h3>Your Content</h3>
              <p>
                You retain all rights to the 3D models and files you upload. By uploading content,
                you grant us a limited license to store and display your content solely for the
                purpose of providing the Service.
              </p>

              <h3>Our Content</h3>
              <p>
                The Service, including its design, features, and code (excluding open-source
                components), is owned by STL Shelf and protected by intellectual property laws.
              </p>
              ...
              <p>
                ...
                backups of important files. We recommend using the export feature regularly.
              </p>

              <h2>Limitation of Liability</h2>
              <p>
                To the maximum extent permitted by law, STL Shelf shall not be liable for any
              ...
              <p>
                You agree to indemnify and hold harmless STL Shelf from any claims, damages, or
              ...
              <p>
                The self-hosted version of STL Shelf is released under an open source license. Use
                of the self-hosted version is governed by that license rather than these Terms,
                except where these Terms specifically apply.
              </p>
              ...
              <p>
                ...
                <a href="mailto:legal@stlshelf.com" className="text-orange-500 hover:underline">
                  legal@stlshelf.com
                </a>
                .
              </p>
