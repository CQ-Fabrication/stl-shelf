    ...
    <div className={cn("absolute inset-0 overflow-hidden", className)}>
          ...
          <div className="h-28 w-44 rounded-lg border border-slate-600/50 bg-gradient-to-b from-slate-700/80 to-slate-800/90 shadow-xl">
                ...
                >
                  ...
                  <div
                    className={cn(
                      ...
                      drive.active && drive.color === "emerald" && "bg-emerald-500 shadow-[0_0_4px_rgba(34,197,94,0.8)] animate-blink",
                      drive.active && drive.color === "orange" && "bg-orange-500 shadow-[0_0_4px_rgba(249,115,22,0.8)] animate-pulse",
                  ...
                  <div className="w-full space-y-0.5">
                    <div className={cn("h-0.5 rounded", drive.active ? "bg-slate-500/30" : "bg-slate-700/20")} />
                    <div className={cn("h-0.5 rounded", drive.active ? "bg-slate-500/30" : "bg-slate-700/20")} />
                  </div>
                </div>
              ))}
            ...
            <div className="absolute bottom-2 left-3 right-3 flex items-center justify-between">
              ...
              <div className="flex items-center gap-1">
                ...
                <div className="h-1 w-1 rounded-full bg-orange-500/60 animate-blink" style={{ animationDelay: "0.3s" }} />
              </div>
            </div>
          </div>
      ...
      <div className="absolute top-4 left-4 flex flex-col gap-1.5">
        <div className="flex items-center gap-1.5">
          <svg className="h-3 w-3 text-orange-400/60" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12" />
          </svg>
          <span className="font-mono text-[8px] text-orange-400/60">↑ 2.4 MB/s</span>
        </div>
        <div className="flex items-center gap-1.5">
          <svg className="h-3 w-3 text-emerald-400/60" fill="none" viewBox="0 0 24 24" stroke="currentColor">
