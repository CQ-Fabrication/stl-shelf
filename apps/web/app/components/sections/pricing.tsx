...
export function Pricing() {
  return (
    <section className="relative py-24 overflow-hidden">
      {/* Isometric grid overlay - matching other sections */}
      <div
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        {/* Bottom note */}
        <div
          className="animate-fade-in-up text-center mt-12 text-sm text-muted-foreground"
          style={{ animationDelay: "0.5s" }}
        >
          All plans include 3D model preview, file organization, and secure storage.
          <br />
          <span className="text-orange-500/80">
            Self-hosting? Check out our open-source version on GitHub.
          </span>
        </div>
      </div>
    </section>
