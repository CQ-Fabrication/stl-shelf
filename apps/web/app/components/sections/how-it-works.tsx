    ...
    <div className="relative h-24 w-full flex items-center justify-center">
      ...
      <div className="relative">
        ...
        <div className="h-16 w-20 rounded-lg border-2 border-dashed border-orange-500/40 bg-orange-500/5 flex items-center justify-center group-hover:border-orange-500/70 group-hover:bg-orange-500/10 transition-all duration-300">
          ...
          <svg viewBox="0 0 24 24" className="h-8 w-8 text-orange-500/60 group-hover:text-orange-400 transition-colors">
            <path
        ...
        <div className="absolute -top-2 -right-3 px-1.5 py-0.5 rounded text-[8px] font-mono bg-orange-500/20 text-orange-400 border border-orange-500/30 animate-float" style={{ animationDelay: '0s' }}>
          .stl
        </div>
        <div className="absolute -bottom-1 -left-4 px-1.5 py-0.5 rounded text-[8px] font-mono bg-emerald-500/20 text-emerald-400 border border-emerald-500/30 animate-float" style={{ animationDelay: '0.5s' }}>
          .3mf
        </div>
      </div>
    </div>
      ...
      <div className="relative flex items-start gap-1">
        ...
        <div className="relative">
          ...
          <svg className="absolute -right-6 top-4 h-12 w-6" viewBox="0 0 24 48">
            <path d="M 0 8 L 12 8 L 12 16 L 24 16" stroke="rgb(249, 115, 22)" strokeWidth="1" fill="none" strokeOpacity="0.4" />
            <path d="M 12 8 L 12 32 L 24 32" stroke="rgb(249, 115, 22)" strokeWidth="1" fill="none" strokeOpacity="0.4" />
          </svg>
        </div>

        {/* Subfolders */}
        <div className="flex flex-col gap-2 ml-6">
          <div className="h-5 w-8 rounded bg-purple-500/20 border border-purple-500/30 animate-pulse-soft" style={{ animationDelay: '0s' }} />
          <div className="h-5 w-8 rounded bg-emerald-500/20 border border-emerald-500/30 animate-pulse-soft" style={{ animationDelay: '0.3s' }} />
        </div>

        {/* Floating tags */}
        <div className="absolute -top-2 right-0 flex gap-1">
          <span className="px-1 py-0.5 rounded text-[7px] font-mono bg-amber-500/20 text-amber-400 border border-amber-500/30">v2.1</span>
        </div>
      </div>
    </div>
  )
      ...
      <div className="relative">
        <svg viewBox="0 0 60 50" className="h-16 w-20">
          ...
          <g className="animate-rotate-slow-y" style={{ transformOrigin: '30px 25px' }}>
            ...
            />
            {/* Connecting edges */}
            <line x1="15" y1="15" x2="22" y2="8" stroke="rgb(249, 115, 22)" strokeWidth="1" strokeOpacity="0.4" />
            <line x1="45" y1="15" x2="52" y2="8" stroke="rgb(249, 115, 22)" strokeWidth="1" strokeOpacity="0.4" />
            <line x1="45" y1="40" x2="52" y2="33" stroke="rgb(249, 115, 22)" strokeWidth="1" strokeOpacity="0.4" />
          </g>
        </svg>
        ...
        <div className="absolute -bottom-1 -right-2 h-5 w-5 rounded-full bg-emerald-500/20 border border-emerald-500/40 flex items-center justify-center">
          <svg viewBox="0 0 24 24" className="h-3 w-3 text-emerald-400">
            <path d="M18 8A3 3 0 1 0 18 2a3 3 0 0 0 0 6zM6 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6zM18 22a3 3 0 1 0 0-6 3 3 0 0 0 0 6zM8.59 13.51l6.83 3.98M15.41 6.51l-6.82 3.98" stroke="currentColor" strokeWidth="2" strokeLinecap="round" fill="none" />
          </svg>
        </div>
      </div>
    </div>
              ...
              >
                <div className="relative h-full p-6 rounded-xl border border-border/50 bg-card/80 backdrop-blur-sm transition-all duration-500 hover:border-orange-500/40 hover:shadow-[0_0_30px_rgba(249,115,22,0.1)] overflow-hidden">
                  ...
                  <div className="relative inline-flex items-center justify-center w-10 h-10 rounded-full border-2 border-orange-500/40 bg-orange-500/10 mb-4 group-hover:border-orange-500/60 group-hover:bg-orange-500/20 group-hover:shadow-[0_0_15px_rgba(249,115,22,0.3)] transition-all duration-300">
                    <span className="font-mono text-sm font-bold text-orange-500">{step.number}</span>
                  </div>
