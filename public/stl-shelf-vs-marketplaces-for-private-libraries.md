# STL Shelf vs marketplaces for users who want a private library

Canonical: https://stl-shelf.com/stl-shelf-vs-marketplaces-for-private-libraries
...
1. **If you want discovery or selling, use a marketplace**: Public distribution and audience reach belong to the marketplace category.
2. **If you want ownership and retrieval, use a library**: Private archive structure is the library category.
3. **If you need both, separate the workflows**: Do not force a publishing platform to become your internal archive when the use cases differ.
...
## What private library software is good at
...
No. STL Shelf is not a marketplace.

### Can STL Shelf replace a marketplace?

Not for discovery or selling. Its role is private archive management, not public distribution.

### Why compare STL Shelf to marketplaces at all?
...
### Is STL Shelf a social platform?
...
- Call to action: Use a private library when ownership is the goal
